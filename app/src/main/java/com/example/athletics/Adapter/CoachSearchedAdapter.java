...
public class CoachSearchedAdapter extends RecyclerView.Adapter<CoachSearchedAdapter.Myviewholder> {
    Context context;
    List<HomeCoachDataItem> muscles;


    public CoachSearchedAdapter(Activity activity, List<HomeCoachDataItem> muscles) {
    ...
    public void onBindViewHolder(@NonNull final Myviewholder holder, final int position) {
        ...
        holder.LLAthlete.setVisibility(View.GONE);
